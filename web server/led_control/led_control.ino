...
IPAddress ip(192, 168, 0, 201); // IP address, may need to change depending on network
...
void ProcessCheckbox(EthernetClient cl)
{
    ...
    if (LED_status) {    // switch LED on
        ...
        cl.println("<input type=\"checkbox\" name=\"LED2\" value=\"1\" \
        onclick=\"submit();\" unchecked>LED2");
    }
}
