...
//             pin, mask, byte
  ...
  //val0 = getKey(35, 32, val0);   /* H */ //23
  val0 = getKey(23, 32, val0);   /* H */ //23

  val1 = getKey(34, 1, val1); /* R */
  val1 = getKey(52, 2, val1); /* A */
  
  val1 = getKey(24, 4, val1); /* O */    //24
  //val1 = getKey(53, 4, val1); /* O */    //24
  
  val1 = getKey(50, 8, val1); /* * */
  
  val1 = getKey(27, 16, val1);   /* E */ //27
  //val1 = getKey(51, 16, val1);   /* E */ //27
  
  val1 = getKey(28, 32, val1);   /* U */  //28
  //val1 = getKey(48, 32, val1);   /* U */  //28
 
  val2 = getKey(47, 1, val2); /* F */  
  val2 = getKey(45, 2, val2); /* R */
  
  //val2 = getKey(49, 4, val2); /* P */ //29
  val2 = getKey(29, 4, val2); /* P */ //29
  
  val2 = getKey(46, 8, val2); /* B */ 
  val2 = getKey(43, 16, val2);   /* L */
  
  //val2 = getKey(44, 32, val2);   /* G */ //22
  val2 = getKey(22, 32, val2);   /* G */ //22
